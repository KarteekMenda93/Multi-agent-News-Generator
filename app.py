...
def generate_content(topic):
    llm = LLM(model="command-r",
              temperature=0.7)
    search_tool = SerperDevTool(n_results=10)
    senior_research_analyst = Agent(role="Senior Research Analyst",
    ...
    research_task = Task(description=("""1. Conduct comprehensive research on {topic} including:
    ...
    writing_task = Task(description=("""Using the research brief provided, create an engaging blog post that:
    ...
    crew = Crew(agents=[senior_research_analyst, 
                        content_writer],
                tasks=[research_task, 
                       writing_task],
                verbose=True
